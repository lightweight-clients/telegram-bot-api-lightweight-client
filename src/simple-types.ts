...
export type GetUpdatesResponse = types.PostGetUpdatesResponse;
export type GetUpdatesOkResponse = types.PostGetUpdatesResponses['200'];

// Types for /setWebhook
export type SetWebhookData = types.PostSetWebhookData['body'];
export type SetWebhookResponse = types.PostSetWebhookResponse;
export type SetWebhookOkResponse = types.PostSetWebhookResponses['200'];

// Types for /deleteWebhook
export type DeleteWebhookData = types.PostDeleteWebhookData['body'];
export type DeleteWebhookResponse = types.PostDeleteWebhookResponse;
export type DeleteWebhookOkResponse = types.PostDeleteWebhookResponses['200'];

// Types for /getWebhookInfo
export type GetWebhookInfoData = types.PostGetWebhookInfoData['body'];
export type GetWebhookInfoResponse = types.PostGetWebhookInfoResponse;
export type GetWebhookInfoOkResponse = types.PostGetWebhookInfoResponses['200'];

// Types for /getMe
export type GetMeData = types.PostGetMeData['body'];
export type GetMeResponse = types.PostGetMeResponse;
export type GetMeOkResponse = types.PostGetMeResponses['200'];

// Types for /logOut
export type LogOutData = types.PostLogOutData['body'];
export type LogOutResponse = types.PostLogOutResponse;
export type LogOutOkResponse = types.PostLogOutResponses['200'];

// Types for /close
export type CloseData = types.PostCloseData['body'];
export type CloseResponse = types.PostCloseResponse;
export type CloseOkResponse = types.PostCloseResponses['200'];

// Types for /sendMessage
export type SendMessageData = types.PostSendMessageData['body'];
export type SendMessageResponse = types.PostSendMessageResponse;
export type SendMessageOkResponse = types.PostSendMessageResponses['200'];

// Types for /forwardMessage
export type ForwardMessageData = types.PostForwardMessageData['body'];
export type ForwardMessageResponse = types.PostForwardMessageResponse;
export type ForwardMessageOkResponse = types.PostForwardMessageResponses['200'];
...
export type CopyMessageResponse = types.PostCopyMessageResponse;
export type CopyMessageOkResponse = types.PostCopyMessageResponses['200'];

// Types for /copyMessages
export type CopyMessagesData = types.PostCopyMessagesData['body'];
export type CopyMessagesResponse = types.PostCopyMessagesResponse;
export type CopyMessagesOkResponse = types.PostCopyMessagesResponses['200'];

// Types for /sendPhoto
export type SendPhotoData = types.PostSendPhotoData['body'];
...
export type SendAudioOkResponse = types.PostSendAudioResponses['200'];

// Types for /sendDocument
export type SendDocumentData = types.PostSendDocumentData['body'];
export type SendDocumentResponse = types.PostSendDocumentResponse;
export type SendDocumentOkResponse = types.PostSendDocumentResponses['200'];

// Types for /sendVideo
export type SendVideoData = types.PostSendVideoData['body'];
export type SendVideoResponse = types.PostSendVideoResponse;
export type SendVideoOkResponse = types.PostSendVideoResponses['200'];

// Types for /sendAnimation
export type SendAnimationData = types.PostSendAnimationData['body'];
export type SendAnimationResponse = types.PostSendAnimationResponse;
export type SendAnimationOkResponse = types.PostSendAnimationResponses['200'];

// Types for /sendVoice
export type SendVoiceData = types.PostSendVoiceData['body'];
export type SendVoiceResponse = types.PostSendVoiceResponse;
export type SendVoiceOkResponse = types.PostSendVoiceResponses['200'];

// Types for /sendVideoNote
export type SendVideoNoteData = types.PostSendVideoNoteData['body'];
export type SendVideoNoteResponse = types.PostSendVideoNoteResponse;
export type SendVideoNoteOkResponse = types.PostSendVideoNoteResponses['200'];

// Types for /sendPaidMedia
export type SendPaidMediaData = types.PostSendPaidMediaData['body'];
export type SendPaidMediaResponse = types.PostSendPaidMediaResponse;
export type SendPaidMediaOkResponse = types.PostSendPaidMediaResponses['200'];

// Types for /sendMediaGroup
export type SendMediaGroupData = types.PostSendMediaGroupData['body'];
export type SendMediaGroupResponse = types.PostSendMediaGroupResponse;
export type SendMediaGroupOkResponse = types.PostSendMediaGroupResponses['200'];

// Types for /sendLocation
export type SendLocationData = types.PostSendLocationData['body'];
export type SendLocationResponse = types.PostSendLocationResponse;
export type SendLocationOkResponse = types.PostSendLocationResponses['200'];

// Types for /sendVenue
export type SendVenueData = types.PostSendVenueData['body'];
export type SendVenueResponse = types.PostSendVenueResponse;
export type SendVenueOkResponse = types.PostSendVenueResponses['200'];

// Types for /sendContact
export type SendContactData = types.PostSendContactData['body'];
export type SendContactResponse = types.PostSendContactResponse;
export type SendContactOkResponse = types.PostSendContactResponses['200'];

// Types for /sendPoll
export type SendPollData = types.PostSendPollData['body'];
export type SendPollResponse = types.PostSendPollResponse;
export type SendPollOkResponse = types.PostSendPollResponses['200'];

// Types for /sendChecklist
export type SendChecklistData = types.PostSendChecklistData['body'];
export type SendChecklistResponse = types.PostSendChecklistResponse;
export type SendChecklistOkResponse = types.PostSendChecklistResponses['200'];
...
export type SendChatActionResponse = types.PostSendChatActionResponse;
export type SendChatActionOkResponse = types.PostSendChatActionResponses['200'];
...
export type GetFileResponse = types.PostGetFileResponse;
export type GetFileOkResponse = types.PostGetFileResponses['200'];

// Types for /banChatMember
export type BanChatMemberData = types.PostBanChatMemberData['body'];
export type BanChatMemberResponse = types.PostBanChatMemberResponse;
export type BanChatMemberOkResponse = types.PostBanChatMemberResponses['200'];
...
export type SetChatPhotoOkResponse = types.PostSetChatPhotoResponses['200'];
...
export type SetChatTitleResponse = types.PostSetChatTitleResponse;
export type SetChatTitleOkResponse = types.PostSetChatTitleResponses['200'];
...
export type PinChatMessageResponse = types.PostPinChatMessageResponse;
export type PinChatMessageOkResponse = types.PostPinChatMessageResponses['200'];
...
export type LeaveChatResponse = types.PostLeaveChatResponse;
export type LeaveChatOkResponse = types.PostLeaveChatResponses['200'];

// Types for /getChat
export type GetChatData = types.PostGetChatData['body'];
export type GetChatResponse = types.PostGetChatResponse;
...
export type EditForumTopicResponse = types.PostEditForumTopicResponse;
export type EditForumTopicOkResponse = types.PostEditForumTopicResponses['200'];
...
export type SetMyCommandsOkResponse = types.PostSetMyCommandsResponses['200'];
...
export type GetMyCommandsResponse = types.PostGetMyCommandsResponse;
export type GetMyCommandsOkResponse = types.PostGetMyCommandsResponses['200'];

// Types for /setMyName
export type SetMyNameData = types.PostSetMyNameData['body'];
export type SetMyNameResponse = types.PostSetMyNameResponse;
export type SetMyNameOkResponse = types.PostSetMyNameResponses['200'];

// Types for /getMyName
export type GetMyNameData = types.PostGetMyNameData['body'];
export type GetMyNameResponse = types.PostGetMyNameResponse;
export type GetMyNameOkResponse = types.PostGetMyNameResponses['200'];
...
export type SendGiftResponse = types.PostSendGiftResponse;
...
export type VerifyUserResponse = types.PostVerifyUserResponse;
export type VerifyUserOkResponse = types.PostVerifyUserResponses['200'];

// Types for /verifyChat
export type VerifyChatData = types.PostVerifyChatData['body'];
export type VerifyChatResponse = types.PostVerifyChatResponse;
...
export type UpgradeGiftResponse = types.PostUpgradeGiftResponse;
export type UpgradeGiftOkResponse = types.PostUpgradeGiftResponses['200'];

// Types for /transferGift
export type TransferGiftData = types.PostTransferGiftData['body'];
export type TransferGiftResponse = types.PostTransferGiftResponse;
export type TransferGiftOkResponse = types.PostTransferGiftResponses['200'];
...
export type EditStoryResponse = types.PostEditStoryResponse;
export type EditStoryOkResponse = types.PostEditStoryResponses['200'];

// Types for /deleteStory
...
export type SendStickerResponse = types.PostSendStickerResponse;
export type SendStickerOkResponse = types.PostSendStickerResponses['200'];

// Types for /getStickerSet
export type GetStickerSetData = types.PostGetStickerSetData['body'];
export type GetStickerSetResponse = types.PostGetStickerSetResponse;
...
export type SendInvoiceResponse = types.PostSendInvoiceResponse;
export type SendInvoiceOkResponse = types.PostSendInvoiceResponses['200'];
...
export type SendGameResponse = types.PostSendGameResponse;
export type SendGameOkResponse = types.PostSendGameResponses['200'];

// Types for /setGameScore
export type SetGameScoreData = types.PostSetGameScoreData['body'];
export type SetGameScoreResponse = types.PostSetGameScoreResponse;
export type SetGameScoreOkResponse = types.PostSetGameScoreResponses['200'];
